...
void _openAttachmentPopup(BuildContext context, String name, String url) {
  ...
  final urlExt = urlPath.contains('.')
      ? urlPath.split('.').last.split('?').first.toLowerCase()
      : '';
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Format $ext — aperçu non disponible',
...
class _ProjetDetailScreenState extends State<ProjetDetailScreen>
    ...
    try {
      ...
      setState(() {
        ...
        _project = Project(
          ...
          budgetTotal: _project.budgetTotal,
          budgetDepense: budgetDepense,
          client: _project.client,
          localisation: _project.localisation,
          chef: _project.chef,
  ...
  Future<void> _terminerProjet() async {
    ...
    try {
      ...
      if (portailActif)
        await ProjetService.updatePortailClient(_project.id, false);
      setState(() {
        _project = Project(
          id: _project.id,
          clientId: _project.clientId,
  ...
  Future<void> _togglePortailClient(bool value) async {
    if (_project.statut == 'termine' || _project.statut == 'annule') {
      _snack(
        context,
        'Le portail client ne peut pas être modifié sur un projet terminé ou annulé',
        kTextSub,
      );
      return;
    }
    ...
    try {
      ...
      _snack(
        context,
        value ? '✓ Portail client activé' : 'Portail client désactivé',
        value ? const Color(0xFF10B981) : kTextSub,
      );
    } catch (e) {
      setState(() {
        _project = Project(
  ...
  String _displayDate(DateTime? d) => d == null
      ? '— Choisir une date'
            ...
            content: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    controller: locCtrl,
                    decoration: _dec('Localisation (nom)', LucideIcons.mapPin),
                  ),
                  const SizedBox(height: 6),
  ...
  Future<void> _loadCommentCount() async {
    try {
      ...
      final lastSeen = prefs.getString(
        'comments_last_seen_${widget.project.id}',
      );
      final comments = await CommentaireService.getCommentaires(
        widget.project.id,
      );
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                    fontWeight: FontWeight.w700,
                                    color: budgetOver ? kRed : kTextMain,
                                    fontSize: 12,
                                  ),
                                ),
                              ],
        ...
        body: TabBarView(
          ...
          children: [
            _TachesTab(
              ...
              onTasksChanged: _loadProgression,
            ),
  ...
  Widget _buildDesktopHeader(Project p) => Row(
    children: [
      Expanded(
        child: Row(
          children: [
            ...
            children: [
              Expanded(
                child: _MobileInfoTile(
                  ...
                  label: 'Client',
                  value: p.client.isEmpty ? '—' : p.client,
                ),
              ),
              const SizedBox(width: 8),
              Expanded(
                child: _MobileInfoTile(
                  ...
                  label: 'Localisation',
                  value: p.localisation.isEmpty ? '—' : p.localisation,
                ),
              ),
            ],
          ),
            ...
            children: [
              ...
              Expanded(
                child: _MobileInfoTile(
                  ...
                  label: 'Budget',
                  value: '${_fmt(p.budgetDepense)} / ${_fmt(p.budgetTotal)} DT',
                ),
              ),
            ],
          ),
    ...
    return SingleChildScrollView(
      ...
      child: Row(
        children: [
          ...
          _CompactChip(
            icon: LucideIcons.mapPin,
            text: p.localisation.isEmpty ? '—' : p.localisation,
          ),
          const SizedBox(width: 8),
          _CompactChip(
            icon: LucideIcons.user,
            text: p.chef.isEmpty ? '—' : p.chef,
          ),
          const SizedBox(width: 8),
          _CompactChip(
            icon: LucideIcons.calendar,
...
class _TachesTabState extends State<_TachesTab> {
  ...
  Future<void> _load() async {
    try {
      final results = await Future.wait([
        ...
        MembreService.getMembresParTacheDetail(
          widget.project.id,
        ).catchError((_) => _membresParTache),
  ...
  int get _enAttente => taches
      .where((t) => t.statut != 'en_cours' && t.statut != 'termine')
      .length;
      ...
      child: Column(
        ...
        children: [
          ...
          if (isMobile) ...[
              ...
              children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      _ViewToggleBtn(
                        ...
                        active: !_showGantt,
                        onTap: () => setState(() => _showGantt = false),
                      ),
                      _ViewToggleBtn(
                        label: 'Gantt',
                        icon: LucideIcons.barChart2,
                        active: _showGantt,
                        onTap: () => setState(() => _showGantt = true),
                      ),
                    ],
                  ),
                ),
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    onPressed: () => _showTacheDialog(
                      context,
                      null,
                      preselectedPhaseId: null,
                    ),
                    icon: const Icon(
                      LucideIcons.plus,
                      size: 14,
            ...
            Row(
              children: [
                ...
                ElevatedButton.icon(
                  onPressed: () =>
                      _showTacheDialog(context, null, preselectedPhaseId: null),
                  icon: const Icon(
                    LucideIcons.plus,
                    size: 14,
                    color: Colors.white,
          ...
          if (_showGantt)
            ...
            _EmptyState(
              icon: LucideIcons.listChecks,
              message: 'Aucune tâche — créez une phase ou une tâche directe',
            )
          else
            _buildListeGroupee(),
        ],
  ...
  Widget _buildListeGroupee() => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      ...phases.map((ph) {
        ...
        return _PhaseSection(
          ...
          onAddTache: () =>
              _showTacheDialog(context, null, preselectedPhaseId: ph.id),
          onEditTache: (t) => _showTacheDialog(context, t),
          onViewTache: (t) => _showViewDialog(context, t),
          onDeleteTache: (t) async {
            await TacheService.deleteTache(t.id);
            _load();
          },
  ...
  List<Widget> _buildTachesSansPhase() {
    ...
    return [
      ...
      if (list.isEmpty && phases.isEmpty)
        _EmptyState(
          icon: LucideIcons.listChecks,
          message: 'Aucune tâche — commencez par en créer une',
        ),
          ...
          child: _TacheCard(
            ...
            onStatusChanged: (s) async {
              await TacheService.updateStatut(
                ...
                s,
                projetId: widget.project.id,
                ancienStatut: e.value.statut,
                budgetEstime: e.value.budgetEstime,
              );
              _load();
            },
            onDelete: () async {
              await TacheService.deleteTache(e.value.id);
              _load();
            },
  ...
  bool _membreDisponible(
    String membreId,
    String debutStr,
    String finStr, {
    String? excludeTacheId,
  }) {
            ...
            children: [
                ...
                child: Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          isEdit ? 'Renommer la phase' : 'Nouvelle phase',
                          style: const TextStyle(
                            fontWeight: FontWeight.w700,
                            fontSize: 15,
              ...
              _DialogActions(
                ...
                onConfirm: () async {
                  ...
                  if (nom.isEmpty) {
                    _snack(context, 'Nom de la phase obligatoire', kRed);
                    return;
                  }
                  if (nom.length < 2) {
                    _snack(
                  ...
                  _snack(
                    context,
                    isEdit ? 'Phase modifiée' : 'Phase créée avec succès',
                    kAccent,
                  );
                },
  ...
  void _confirmDeletePhase(BuildContext context, Phase ph) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text(
          'La phase "${ph.nom}" sera supprimée. Les tâches associées resteront sans phase.',
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              await PhaseService.deletePhase(ph.id);
              Navigator.pop(context);
              _load();
              _snack(context, 'Phase supprimée', kRed);
            },
            child: const Text(
              'Supprimer',
  ...
  void _showTacheDialog(
    BuildContext context,
    Tache? existing, {
    String? preselectedPhaseId,
  }) {
    ...
    final budgetCtrl = TextEditingController(
      text: existing != null && existing.budgetEstime > 0
          ? existing.budgetEstime.toInt().toString()
          : '',
    );
    final remarquesCtrl = TextEditingController(
      text: existing?.remarques ?? '',
    );
    ...
    final selectedMembres = Set<String>.from(
      isEdit
          ? (_membresParTache[existing!.id]?.map((m) => m['id'] as String) ??
                [])
          : <String>[],
    );
    ...
    showDialog(
      ...
      builder: (_) => StatefulBuilder(
        builder: (ctx, sd) {
          ...
          _pollTimer ??= Timer.periodic(const Duration(milliseconds: 600), (
            _,
          ) async {
            if (viewerCtrl == null) return;
            try {
              ...
              final clicks =
                  jsonDecode(raw.replaceAll('"', '"').replaceAll('"', '"'))
                      as List;
              if (clicks.isNotEmpty) {
                ...
                for (final name in clicks) {
                  ...
                  sd(() {
                    if (selectedMeshes.contains(meshName))
                      selectedMeshes.remove(meshName);
                    else
                      selectedMeshes.add(meshName);
                  });
                      ...
                      builder: (_) => AlertDialog(
                        ...
                        content: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 8),
                            Text(
                              selectedMeshes.contains(meshName)
                                  ? '✓ Associée à cette tâche'
                                  : 'Désassociée de cette tâche',
                              style: TextStyle(
                                fontSize: 12,
                                color: selectedMeshes.contains(meshName)
                                    ? const Color(0xFF10B981)
                                    : kTextSub,
                              ),
                            ),
            ...
            children: [
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                ...
                                fontWeight: statut == s
                                    ? FontWeight.w700
                                    : FontWeight.w500,
                                color: statut == s ? _tacheColor(s) : kTextSub,
                              ),
                            ),
                          ),
                        ),
              ...
              if (_tousLesMembres.isNotEmpty) ...[
                ...
                Builder(
                  builder: (_) {
                    final hasDates =
                        debutCtrl.text.isNotEmpty && finCtrl.text.isNotEmpty;
                      ...
                      return Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              hasDates
                                  ? 'Aucun membre disponible sur cette période'
                    ...
                    return Wrap(
                      ...
                      children: [
                        for (final m in membres)
                          GestureDetector(
                            onTap: () => sd(() {
                              if (selectedMembres.contains(m.id))
                                selectedMembres.remove(m.id);
                              else
                                selectedMembres.add(m.id);
                            }),
                            child: AnimatedContainer(
                              duration: const Duration(milliseconds: 150),
                              padding: const EdgeInsets.symmetric(
                              ...
                              decoration: BoxDecoration(
                                color: selectedMembres.contains(m.id)
                                    ? kAccent
                                    : Colors.white,
                                borderRadius: BorderRadius.circular(20),
                                border: Border.all(
                ...
                if (debutCtrl.text.isEmpty || finCtrl.text.isEmpty)
                  const Padding(
                    padding: EdgeInsets.only(top: 6),
                    child: Text(
                      'Sélectionnez les dates pour filtrer les membres disponibles',
                      style: TextStyle(fontSize: 10, color: kTextSub),
                    ),
                  ),
              ],
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: ClipRRect(
                          child: WebViewWidget(controller: viewerCtrl!),
                        ),
                      ),
                      // Mesh list header
                      Padding(
                      ...
                      const Padding(
                        ...
                        child: Text(
                          'Cliquez sur le modèle ou sur un chip pour associer une partie à cette tâche.',
                          style: TextStyle(fontSize: 10, color: kTextSub),
                        ),
                      ),
                      const SizedBox(height: 10),
                              ...
                              for (final name in _model3D!.meshNames)
                                GestureDetector(
                                  onTap: () {
                                    sd(() {
                                      if (selectedMeshes.contains(name))
                                        selectedMeshes.remove(name);
                                      else
                                        selectedMeshes.add(name);
                                    });
                                    highlightSelected(sd);
                                    if (selectedMeshes.contains(name)) {
                                      viewerCtrl!.runJavaScript(
                                        'zoomToMesh(${jsonEncode(name)});',
                                      );
                                    }
                                      ...
                                      builder: (_) => AlertDialog(
                                        ...
                                        content: Column(
                                          ...
                                          children: [
                                            ...
                                            const SizedBox(height: 8),
                                            Text(
                                              selectedMeshes.contains(name)
                                                  ? '✓ Associée à cette tâche'
                                                  : 'Désassociée de cette tâche',
                                              style: TextStyle(
                                                fontSize: 12,
                                                color:
                                                    selectedMeshes.contains(
                                                      name,
                                                    )
                                                    ? const Color(0xFF10B981)
                                                    : kTextSub,
                                  ...
                                  child: AnimatedContainer(
                                    ...
                                    decoration: BoxDecoration(
                                      color: selectedMeshes.contains(name)
                                          ? kAccent
                                          : Colors.white,
                                      borderRadius: BorderRadius.circular(20),
                                      border: Border.all(
                ...
                children: [
                  ...
                  _DialogActions(
                    ...
                    onConfirm: () async {
                      ...
                      if (titre.isEmpty) {
                        _snack(ctx, 'Titre de la tâche obligatoire', kRed);
                        return;
                      }
                      if (titre.length < 2) {
                        _snack(
                      ...
                      if (descCtrl.text.trim().isEmpty) {
                        _snack(ctx, 'Description obligatoire', kRed);
                        return;
                      }
                      if (debutCtrl.text.isEmpty) {
                        _snack(ctx, 'Date de début obligatoire', kRed);
                        return;
                      }
                      if (finCtrl.text.isEmpty) {
                        _snack(ctx, 'Date de fin obligatoire', kRed);
                        return;
                      }
                      final d = DateTime.tryParse(debutCtrl.text);
                      final f = DateTime.tryParse(finCtrl.text);
                      ...
                      if (budgetVal.isEmpty) {
                        _snack(ctx, 'Budget prévu obligatoire', kRed);
                        return;
                      }
                      final b = double.tryParse(budgetVal.replaceAll(' ', ''));
                      if (b == null) {
                        _snack(ctx, 'Budget invalide', kRed);
                        return;
                      }
                      if (b < 0) {
                        _snack(ctx, 'Le budget ne peut pas être négatif', kRed);
                        return;
                      }
                      if (b > 999999999) {
                        _snack(ctx, 'Budget trop élevé', kRed);
                        return;
                      }
                      final t = Tache(
                        ...
                        statut: statut,
                        dateDebut: debutCtrl.text.trim().isEmpty
                            ? null
                            : debutCtrl.text.trim(),
                        dateFin: finCtrl.text.trim().isEmpty
                            ? null
                            : finCtrl.text.trim(),
                        budgetEstime:
                            double.tryParse(
                      ...
                      try {
                        if (isEdit) {
                          ...
                          await MembreService.assignMembresForTache(
                            t.id,
                            selectedMembres.toList(),
                            widget.project.id,
                          );
                        } else {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _ViewInfoTile(
                      icon: LucideIcons.banknote,
                      label: 'Budget prévu',
                      value: t.budgetEstime > 0 ? _fmtNum(t.budgetEstime) : '—',
                    ),
                    if ((_membresNomParTache[t.id] ?? []).isNotEmpty) ...[
                      ...
                      _ViewInfoTile(
                        ...
                        value: (_membresNomParTache[t.id] ?? []).join(', '),
                      ),
                    ],
...
class _PhaseSection extends StatefulWidget {
  ...
  const _PhaseSection({
    ...
    this.membresNomParTache = const {},
    required this.onAddTache,
    required this.onEditTache,
    required this.onViewTache,
    required this.onDeleteTache,
        ...
        children: [
              ...
              children: [
                Row(
                  children: [
                    ...
                    PopupMenuButton<String>(
                      onSelected: (v) {
                        if (v == 'add') widget.onAddTache();
                        if (v == 'edit') widget.onEditPhase();
                        if (v == 'delete') widget.onDeletePhase();
                      },
                      itemBuilder: (_) => [
                        const PopupMenuItem(
                          value: 'add',
                          child: Row(
                            children: [
                              Icon(LucideIcons.plus, size: 14, color: kAccent),
                              SizedBox(width: 8),
                        ...
                        const PopupMenuItem(
                          ...
                          child: Row(
                            children: [
                              Icon(LucideIcons.trash2, size: 14, color: kRed),
                              SizedBox(width: 8),
          ...
          if (_expanded) ...[
            ...
            if (widget.taches.isEmpty)
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Icon(LucideIcons.plus, size: 13, color: kAccent),
                      const SizedBox(width: 6),
                      const Text(
              ...
              ...widget.taches.asMap().entries.map(
                (e) => Padding(
                  ...
                  child: _TacheCard(
                    ...
                    index: e.key + 1,
                    assignedMembres:
                        widget.membresNomParTache[e.value.id] ?? [],
...
class _TacheCard extends StatefulWidget {
  ...
  const _TacheCard({
    ...
    this.assignedMembres = const [],
  });
  @override
  State<_TacheCard> createState() => _TacheCardState();
}
...
class _TacheCardState extends State<_TacheCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final pct = tache.statut == 'termine'
        ? 100
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: noMembre
            ? Border.all(color: kRed, width: 1.5)
        ...
        child: Column(
          ...
          children: [
                ...
                PopupMenuButton<String>(
                  ...
                  itemBuilder: (_) => [
                    const PopupMenuItem(
                      ...
                      child: Row(
                        children: [
                          Icon(LucideIcons.eye, size: 14, color: kTextSub),
                          SizedBox(width: 8),
                          Text('Consulter'),
                        ],
                      ),
                    ...
                    const PopupMenuItem(
                      ...
                      child: Row(
                        children: [
                          Icon(LucideIcons.pencil, size: 14, color: kAccent),
                          SizedBox(width: 8),
                          Text('Modifier'),
                        ],
                      ),
            ...
            if (tache.dateDebut != null ||
              ...
              if (tache.dateDebut != null || tache.dateFin != null)
                _InfoRow(
                  icon: LucideIcons.calendarDays,
                  label: 'Dates',
                  value: '${tache.dateDebut ?? "?"} → ${tache.dateFin ?? "?"}',
                ),
              if (tache.budgetEstime > 0) ...[
                ...
                _InfoRow(
                  icon: LucideIcons.dollarSign,
                  label: 'Budget prévu',
                  value: _fmtNum(tache.budgetEstime),
                ),
              ],
            ],
            if (tache.remarques.isNotEmpty) ...[
              ...
              GestureDetector(
                onTap: () =>
                    setState(() => _remarquesExpanded = !_remarquesExpanded),
                child: Row(
                  children: [
                    Container(
                      padding: const EdgeInsets.symmetric(
                      ...
                      children: [
                        ...
                        if (widget.assignedMembres.length > 3)
                          Container(
                            ...
                            child: Text(
                              '+${widget.assignedMembres.length - 3}',
                              style: const TextStyle(
                                fontSize: 11,
                                color: kTextSub,
                                fontWeight: FontWeight.w600,
...
class _FinancesTabState extends State<_FinancesTab> {
  ...
  // ── Accesseurs ──────────────────────────────────────────────────────────────
  Facture? get _devisInitial => _factures
      .where((f) => (f.factureType ?? 'extra') == 'initiale')
      .firstOrNull;
  ...
  double get _pct =>
      _budgetTotal > 0 ? (_totalFacture / _budgetTotal).clamp(0.0, 1.1) : 0.0;
        ...
        const Expanded(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 3),
              Text(
                'Devis initial · Factures · Suivi budgétaire',
                style: TextStyle(color: kTextSub, fontSize: 12),
              ),
            ],
          ),
  ...
  Widget _buildKpis(bool isMobile) {
    ...
    final cards = [
      _KpiCard(
        label: 'Budget projet',
        value: widget.fmt(_budgetTotal),
        color: const Color(0xFF6366F1),
        icon: LucideIcons.wallet,
      ),
      _KpiCard(
        label: 'Devis initial',
        value: _devisInitial != null ? widget.fmt(_montantDevis) : '—',
        color: const Color(0xFF8B5CF6),
        icon: LucideIcons.fileText,
      ),
      _KpiCard(
        label: 'Total factures',
        value: widget.fmt(_totalFacture),
        color: barColor,
        icon: LucideIcons.receipt,
      ),
      _KpiCard(
        label: _depasse ? 'Dépassement' : 'Reste',
        value: widget.fmt(_ecart.abs()),
        color: _depasse ? kRed : const Color(0xFF10B981),
        icon: _depasse ? LucideIcons.alertTriangle : LucideIcons.trendingDown,
      ),
    ];
    if (isMobile) {
      return Column(
      ...
      child: Column(
        ...
        children: [
          ...
          LayoutBuilder(
            builder: (ctx, cs) {
              final W = cs.maxWidth;
              final maxVal = _budgetTotal > 0
                  ? _budgetTotal
                  : (_totalFacture > 0 ? _totalFacture * 1.1 : 1.0);
              final wDevis = _budgetTotal > 0
                  ? ((_montantDevis / maxVal) * W).clamp(0.0, W)
                  : 0.0;
              final wExtra = _budgetTotal > 0
                  ? ((_totalExtra / maxVal) * W).clamp(0.0, W - wDevis)
                  : 0.0;
              final wBudget = W;
              return Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.only(
                                ...
                                topRight: Radius.circular(wExtra == 0 ? 6 : 0),
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.only(
                                topLeft: Radius.circular(wDevis == 0 ? 6 : 0),
                            ...
                            Row(
                              children: [
                                _BarLegend(
                                  color: const Color(0xFF8B5CF6),
                                  label: 'Devis initial',
                                  value: widget.fmt(_montantDevis),
                                ),
                                const SizedBox(width: 16),
                                _BarLegend(
                                  color: const Color(0xFFF59E0B),
                                  label: 'Extras',
                                  value: widget.fmt(_totalExtra),
                                ),
                              ],
                            ),
                            const SizedBox(height: 6),
    ...
    return Column(
      ...
      children: [
          ...
          children: [
            ...
            const Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Premier devis estimatif du projet',
            ...
            if (_devisInitial == null)
              ...
              _FinBtn(
                ...
                color: const Color(0xFF8B5CF6),
                onTap: () =>
                    _ouvrirDialog(isInitiale: true, existing: _devisInitial),
              ),
          ],
        ),
        const SizedBox(height: 12),
        if (_devisInitial == null)
          ...
          _DevisCard(
            facture: _devisInitial!,
            fmt: widget.fmt,
            onDelete: () => _supprimerFacture(_devisInitial!),
          ),
      ],
    );
  }
          ...
          children: [
            ...
            if (toutes.isEmpty)
              const Padding(
                ...
                child: Center(
                  child: Text(
                    'Aucune facture — créez d\'abord le devis initial',
                    style: TextStyle(color: kTextSub, fontSize: 13),
                    textAlign: TextAlign.center,
                  ),
                ),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    const Spacer(),
                    Text(
                      widget.fmt(_totalFacture),
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w800,
                        color: _depasse ? kRed : kTextMain,
                      ),
                    ),
                  ],
                ),
                ...
                const Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 2),
                      Text(
                        'Devis initial + avenants + factures entreprises',
                        style: TextStyle(fontSize: 11, color: kTextSub),
                      ),
                    ],
                  ),
...
class _LigneFacture extends StatelessWidget {
  ...
  Widget _buildCard(BuildContext context) {
    ...
    final emetteur = f.fournisseur.isNotEmpty
        ? f.fournisseur
        : (f.chefProjet.isNotEmpty ? f.chefProjet : null);
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    if (raw.startsWith('fichier:')) {
                      _snack(
                        context,
                        'Fichier local non accessible. Modifiez la facture pour ré-uploader.',
                        const Color(0xFFF59E0B),
                      );
                    } else {
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            flex: 2,
            child: Text(
              f.fournisseur.isNotEmpty
                  ? f.fournisseur
                  : (f.chefProjet.isNotEmpty ? f.chefProjet : '—'),
              style: const TextStyle(fontSize: 12, color: kTextSub),
              overflow: TextOverflow.ellipsis,
            ),
          ),
          Expanded(
            flex: 2,
            child: Text(
              f.dateEcheance?.isNotEmpty == true ? f.dateEcheance! : '—',
              style: const TextStyle(fontSize: 12, color: kTextSub),
            ),
          ),
          Expanded(
                ...
                PopupMenuButton<String>(
                  ...
                  itemBuilder: (_) => [
                    const PopupMenuItem(
                      ...
                      child: Row(
                        children: [
                          Icon(LucideIcons.pencil, size: 13, color: kAccent),
                          SizedBox(width: 8),
                          Text('Modifier'),
                        ],
                      ),
...
class _DevisCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final pills = <Widget>[
      if (f.fournisseur.isNotEmpty) ...[
        _DevisPill(icon: LucideIcons.building2, label: f.fournisseur),
        const SizedBox(width: 8),
      ],
      if (f.dateEcheance?.isNotEmpty == true) ...[
        _DevisPill(icon: LucideIcons.calendar, label: f.dateEcheance!),
        const SizedBox(width: 8),
      ],
      if (f.chefProjet.isNotEmpty)
        _DevisPill(icon: LucideIcons.user, label: f.chefProjet),
    ];
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      f.numero.isNotEmpty ? f.numero : 'Devis initial',
                      style: const TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.w700,
                        color: kTextMain,
          ...
          if (isMobile) ...[
            ...
            Row(children: [pjBtn, const Spacer(), delBtn]),
          ] else ...[
    ...
    child: Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 3),
          const Text(
            'Créez le premier devis estimatif pour ce projet',
            style: TextStyle(fontSize: 11, color: kTextSub),
            textAlign: TextAlign.center,
          ),
        ],
    ...
    children: [
      Container(
        ...
        decoration: BoxDecoration(
          ...
          border: dark ? Border.all(color: const Color(0xFFD1D5DB)) : null,
        ),
      ),
      const SizedBox(width: 5),
      Column(
...
class _FactureDialog extends StatefulWidget {
  ...
  const _FactureDialog({
    required this.project,
    required this.isInitiale,
    this.existing,
    required this.onSaved,
  });
  @override
  State<_FactureDialog> createState() => _FactureDialogState();
}
...
class _FactureDialogState extends State<_FactureDialog> {
  ...
  Future<void> _loadPhasesEtTaches() async {
    ...
    try {
      ...
      if (widget.existing != null &&
          widget.existing!.tacheAssociee.isNotEmpty) {
        final match = taches
            .where((t) => t.titre == widget.existing!.tacheAssociee)
            .firstOrNull;
  ...
  Future<void> _pickFile() async {
    try {
      ...
      try {
        ...
        _snack(
          context,
          'Upload impossible — fichier enregistré localement',
          const Color(0xFFF59E0B),
        );
      }
    } catch (_) {
  ...
  Future<void> _submit() async {
    ...
    if (num.isEmpty) {
      _snack(context, 'Numéro / référence obligatoire', kRed);
      return;
    }
    if (_montantCtrl.text.trim().isEmpty) {
      _snack(context, 'Montant obligatoire', kRed);
      return;
    }
    ...
    if (m == null || m <= 0) {
      _snack(context, 'Montant invalide', kRed);
      return;
    }
    if (_fournCtrl.text.trim().isEmpty) {
      _snack(
        context,
        widget.isInitiale
            ? 'Établi par obligatoire'
            : 'Fournisseur obligatoire',
        kRed,
      );
      return;
    }
    if (_echeanceCtrl.text.trim().isEmpty) {
      _snack(context, "Date d'échéance obligatoire", kRed);
      return;
    }
    ...
    final facture = Facture(
      ...
      montant: m,
      statut: _statut,
      dateEcheance: _echeanceCtrl.text.trim().isEmpty
          ? null
          : _echeanceCtrl.text.trim(),
    ...
    widget.onSaved(
      widget.existing != null ? 'Facture modifiée' : 'Facture ajoutée',
    );
  }
                            ...
                            ? Row(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        'Joindre une pièce jointe (facultatif)',
                                        style: TextStyle(
                                          fontSize: 13,
                                          fontWeight: FontWeight.w600,
                                          color: _accent,
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          _echeanceCtrl.text.isEmpty
                                              ? 'Sélectionner *'
                                              : _echeanceCtrl.text,
                                          style: TextStyle(
                                            fontSize: 13,
                                            color: _echeanceCtrl.text.isEmpty
                                                ? kTextSub
                                                : kTextMain,
                                          ),
                                        ),
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton<String?>(
                              ...
                              onChanged: (v) => setState(() {
                                _selectedPhaseId = v;
                                _selectedTacheId =
                                    null; // reset tâche quand phase change
                              }),
                            ),
                          ),
                        ),
                        ...
                        Container(
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton<String?>(
                              ...
                              onChanged: _tachesDeLaPhase.isEmpty
                                  ? null
                                  : (v) => setState(() => _selectedTacheId = v),
                            ),
                          ),
                        ),
                      ],
...
class _GanttViewState extends State<_GanttView> {
  ...
  Widget build(BuildContext context) {
      ...
      return Container(
        ...
        child: const Column(
          ...
          children: [
            ...
            SizedBox(height: 6),
            Text(
              'Ajoutez des dates de début et fin à vos tâches pour afficher le diagramme de Gantt',
              style: TextStyle(color: kTextSub, fontSize: 12),
              textAlign: TextAlign.center,
            ),
          ],
    ...
    DateTime minDate = withDates
        .map((t) => _d(t.dateDebut)!)
        .reduce((a, b) => a.isBefore(b) ? a : b);
    DateTime maxDate = withDates
        .map((t) => _d(t.dateFin)!)
    ...
    final inRange =
        today.isAfter(minDate.subtract(const Duration(days: 1))) &&
        ...
        children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(8),
                      border: Border.all(
                        color: inRange ? kRed.withOpacity(0.5) : Colors.white24,
                      ),
                    ),
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
          ...
          LayoutBuilder(
            builder: (ctx, cs) {
              ...
              final colW = columns.isEmpty
                  ? minColW
                  : (availW / columns.length).clamp(minColW, 300.0);
              final chartW = colW * columns.length;
              final todayX = inRange
                  ? (today.difference(minDate).inDays / totalDays * chartW)
                        .clamp(0.0, chartW)
                  : 0.0;
                ...
                chartRows.add(
                  SizedBox(
                    ...
                    child: Stack(
                      children: [
                        Positioned.fill(
                          child: Container(color: phColor.withOpacity(0.04)),
                        ),
                        ...gridSeps(),
                        todayLine(),
                      ],
              ...
              void addTaskRow(Tache t) {
                ...
                final barW = (daysW / totalDays * chartW).clamp(
                  6.0,
                  chartW - barL,
                );
                final pct = t.statut == 'termine'
                    ? 1.0
                    : t.statut == 'en_cours'
                    ? 0.5
                    : 0.0;
                ...
                labelRows.add(
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: bg,
                      border: const Border(right: BorderSide(color: _sepCol)),
                    ),
                    padding: const EdgeInsets.symmetric(
                      horizontal: 10,
                      vertical: 4,
              ...
              for (final ph in widget.phases) {
                ...
                final prog =
                    phT.where((t) => t.statut == 'termine').length / phT.length;
                final color = prog == 1.0
                    ? _greenOk
                    : prog > 0
                    ? kAccent
                    : _greyNone;
              ...
              if (sansPh.isNotEmpty) {
                if (widget.phases.any(
                  (p) => withDates.any((t) => t.phaseId == p.id),
                )) {
                  ...
                  child: Stack(
                    children: [
                      ...months.asMap().entries.map((e) {
                        ...
                        final m = e.value;
                        final x =
                            m.difference(minDate).inDays / totalDays * chartW;
                        final nxt = i + 1 < months.length
                            ? months[i + 1].difference(minDate).inDays /
                                  totalDays *
                                  chartW
                            : chartW;
                        return Positioned(
                          left: x,
                          width: (nxt - x).clamp(0.0, chartW),
                          top: 0,
                          bottom: 0,
                          child: Container(
                            decoration: BoxDecoration(
                      ...
                      if (inRange) ...[
                        ...
                        Positioned(
                          left: (todayX - 14).clamp(0.0, chartW - 32),
                          top: 6,
                          width: 32,
                          child: Container(
                            padding: const EdgeInsets.symmetric(
                          ...
                          children: [
                            ...months.asMap().entries.map((e) {
                              ...
                              return Positioned(
                                ...
                                width: (nxt - x.clamp(0.0, chartW)).clamp(
                                  0.0,
                                  chartW,
                                ),
                                top: 0,
                        ...
                        child: Stack(
                          children: [
                            ...weeks.asMap().entries.map((e) {
                              ...
                              final w = e.value;
                              final x =
                                  w.difference(minDate).inDays /
                                  totalDays *
                                  chartW;
                              final nxt = i + 1 < weeks.length
                                  ? weeks[i + 1].difference(minDate).inDays /
                                        totalDays *
                                        chartW
                                  : chartW;
                            ...
                            if (inRange) ...[
                              ...
                              Positioned(
                                left: (todayX - 12).clamp(0.0, chartW - 28),
                                top: 3,
                                width: 28,
                                child: Container(
                                  padding: const EdgeInsets.symmetric(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 5),
                      Text(
                        '${withoutDates.length} tâche(s) sans dates :',
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              border: Border(top: BorderSide(color: _sepCol)),
            ),
            child: Row(
              children: [
                ...
                if (inRange) ...[
                  ...
                  Text(
                    "Aujourd'hui",
                    style: TextStyle(fontSize: fsSub, color: kTextSub),
                  ),
                ],
              ],
            ),
...
class _DocumentsTabState extends State<_DocumentsTab> {
  ...
  List<_DocUI> get _filtered {
    var list = _filterPhase == 'Toutes les phases'
        ? List<_DocUI>.from(_documentsUI)
        : _documentsUI.where((d) => d.phase == _filterPhase).toList();
    ...
    switch (_sortBy) {
      ...
      case 'nom':
        list.sort(
          (a, b) =>
              a.nomAffiche.toLowerCase().compareTo(b.nomAffiche.toLowerCase()),
        );
      default: // 'date'
        list.sort((a, b) {
          final da = a.dateDoc ?? a.doc.uploadedAt ?? '';
          final db = b.dateDoc ?? b.doc.uploadedAt ?? '';
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              const Expanded(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    SizedBox(height: 4),
                    Text(
                      'Gérez vos plans, permis et dossiers par phase architecturale.',
                      style: TextStyle(color: kTextSub, fontSize: 12),
                    ),
                  ],
                ),
              ...
              ElevatedButton.icon(
                ...
                label: Text(
                  isMobile ? 'Livrable' : 'Nouveau livrable',
                  style: const TextStyle(
                    color: Colors.white,
                    fontWeight: FontWeight.w600,
                    fontSize: 12,
          ...
          SingleChildScrollView(
            scrollDirection: Axis.horizontal,
            child: Row(
              children: kDocPhases.map((phase) {
                final isSelected = _filterPhase == phase;
                final color = phase == 'Toutes les phases'
                    ? kAccent
                    : _phaseColor(phase);
                return Padding(
          ...
          Row(
            children: [
              ...
              _SortChip(
                ...
                value: 'version',
                current: _sortBy,
                onTap: () => setState(() => _sortBy = 'version'),
              ),
              const SizedBox(width: 6),
              _SortChip(
                label: 'Nom',
      ...
      return Container(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              _filterPhase == 'Toutes les phases'
                  ? 'Aucun document pour ce projet'
                  : 'Aucun document pour la phase $_filterPhase',
              style: const TextStyle(
                color: kTextMain,
                fontSize: 14,
                fontWeight: FontWeight.w600,
            ...
            const SizedBox(height: 6),
            const Text(
              'Ajoutez vos plans, devis et livrables',
              style: TextStyle(color: kTextSub, fontSize: 12),
            ),
            const SizedBox(height: 20),
            OutlinedButton.icon(
                ...
                children: [
                  for (int j = 0; j < rowItems.length; j++) ...[
                    ...
                    Expanded(
                      child: _DocumentCard(
                        docUI: rowItems[j],
                        onOpen: () => _openAttachmentPopup(
                          context,
                          rowItems[j].nomAffiche,
                          rowItems[j].doc.url,
                        ),
                        onDelete: () async {
                          ...
                          _snack(context, 'Document supprimé', kRed);
                          _load();
                        },
                      ),
                    ),
  ...
  void _showAddLivrableDialog(BuildContext context) {
    showDialog(
      context: context,
      builder: (_) => _AddLivrableDialog(
        projectId: widget.project.id,
        onSaved: () {
          _load();
          _snack(context, 'Livrable ajouté avec succès', kAccent);
        },
      ),
    );
  }
...
class _DocumentCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = _phaseColor(docUI.phase);
    final hasDate = docUI.dateDoc != null && docUI.dateDoc!.isNotEmpty;
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Icon(
                          _docIconFromLabel(docUI.typeLabel),
                          size: 20,
                          color: color,
                        ),
                      ),
                  ...
                  // ── Ligne 2 : version + date + bouton voir ─────────────────────
                  Row(
                    children: [
                      // Version
                      Container(
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: const Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Icon(LucideIcons.eye, size: 12, color: kAccent),
                              SizedBox(width: 5),
                              Text(
                                'Ouvrir',
                                style: TextStyle(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(8),
          border: Border.all(
            color: selected ? kAccent : const Color(0xFFE5E7EB),
          ),
        ),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(icon, size: 11, color: selected ? Colors.white : kTextSub),
            const SizedBox(width: 4),
            Text(
              label,
              style: TextStyle(
...
class _AddLivrableDialog extends StatefulWidget {
  ...
  @override
  State<_AddLivrableDialog> createState() => _AddLivrableDialogState();
}
...
class _AddLivrableDialogState extends State<_AddLivrableDialog> {
    ...
    try {
      ...
      if (file.bytes != null) {
        ...
        try {
          ...
          _snack(
            context,
            'Upload échoué — lien local conservé',
            const Color(0xFFF59E0B),
          );
        }
      } else {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final nomEncode =
          '$nom||META||$_phase||META||$_typeLabel||META||$version||META||${_dateCtrl.text.trim()}';
          ...
          child: Column(
            ...
            children: [
              _DialogHeader(
                ...
                subtitle: 'Ajoutez un document à une phase',
              ),
              Padding(
                padding: const EdgeInsets.all(20),
                child: Column(
                                  ...
                                  Text(
                                    _uploading
                                        ...
                                        ? (_urlCtrl.text.startsWith('http')
                                              ? 'Uploadé ✓ — accessible en ligne'
                                              : 'Fichier local (pas de réseau)')
...
class _EquipeTabState extends State<_EquipeTab> {
  ...
  Future<void> _load() async {
    try {
      ...
      final viaTitre = await MembreService.getMembresByProject(
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 6),
                  const Text(
                    'Assignez des membres depuis la gestion des membres',
                    style: TextStyle(color: kTextSub, fontSize: 12),
                  ),
                ],
              ),
                          ...
                          for (int j = 0; j < row.length; j++) ...[
                            ...
                            Expanded(
                              child: _MembreCard(
                                ...
                                isChef:
                                    widget.project.chef.isNotEmpty &&
                                    row[j].nom.toLowerCase().contains(
                                      widget.project.chef.toLowerCase(),
                                    ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(14),
        border: Border.all(
          color: isChef ? kAccent.withOpacity(0.35) : const Color(0xFFE5E7EB),
        ),
        boxShadow: [
          BoxShadow(
            color: Colors.black.withOpacity(0.04),
            ...
            child: Column(
              ...
              children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              m.role.isNotEmpty ? m.role : 'Membre',
                              style: TextStyle(
                                color: avatarColor,
                                fontSize: 10,
                                fontWeight: FontWeight.w700,
                ...
                if (m.specialite != null && m.specialite!.isNotEmpty) ...[
                  Row(
                    children: [
                      const Icon(LucideIcons.award, size: 13, color: kTextSub),
                      const SizedBox(width: 8),
                      Expanded(
                        child: Text(
                          m.specialite!,
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 4),
                            Text(
                              '${m.projetsAssignes.length} projet${m.projetsAssignes.length > 1 ? "s" : ""}',
                              style: const TextStyle(
                                fontSize: 10,
                                color: kTextSub,
                                fontWeight: FontWeight.w600,
...
class _SuiviPhotosTab extends StatefulWidget {
  ...
  @override
  State<_SuiviPhotosTab> createState() => _SuiviPhotosTabState();
}
...
class _SuiviPhotosTabState extends State<_SuiviPhotosTab> {
  ...
  Future<void> _loadDefauts() async {
    try {
      ...
      if (mounted)
        setState(() {
          _defauts = List<Map<String, dynamic>>.from(data);
          _loadingDefauts = false;
        });
    } catch (_) {
      if (mounted) setState(() => _loadingDefauts = false);
    }
  }
  ...
  Future<void> _loadDocuments() async {
    try {
      ...
      if (mounted)
        setState(() => _documents = List<Map<String, dynamic>>.from(data));
    } catch (_) {}
  }
  ...
  Future<void> _loadCRC() async {
    try {
      ...
      if (mounted) setState(() => _loadingCRC = false);
    }
  }
  ...
  Future<void> _ajouterPhotos() async {
    try {
      ...
      if (ok > 0)
        _snack(context, '$ok photo(s) ajoutée(s) ✓', const Color(0xFF10B981));
      else
        _snack(context, "Erreur lors de l'upload", kRed);
      await _loadPhotos();
    } catch (_) {
  ...
  Future<void> _supprimerPhoto(Map<String, dynamic> photo) async {
    try {
      ...
      _snack(context, 'Erreur suppression', kRed);
    }
  }
                        ...
                        const Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Rapport officiel de visite ou de réunion',
                                style: TextStyle(color: kTextSub, fontSize: 12),
                              ),
                            ],
                          ),
                    ...
                    child: Column(
                      ...
                      children: [
                        _DField(
                          ...
                          hint: 'Ex: Rapport de visite — Semaine 15',
                          controller: titreCtrl,
                        ),
                        const SizedBox(height: 12),
                        _DField(
                          icon: LucideIcons.alignLeft,
                          label: 'CONTENU / OBSERVATIONS',
                          hint:
                              'Décrivez les observations, décisions et actions à prendre...',
                        ...
                        Expanded(
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              final titre = titreCtrl.text.trim();
                              if (titre.isEmpty) {
                                _snack(ctx, 'Titre obligatoire', kRed);
                                return;
                              }
                              ...
                              try {
                                ...
                                _snack(ctx, 'Erreur sauvegarde', kRed);
                              }
                            },
                            child: const Text(
                              'Créer le rapport',
                        ...
                        const Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Note rapide, info informelle ou observation terrain',
                                style: TextStyle(color: kTextSub, fontSize: 12),
                              ),
                            ],
                          ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _DField(
                          ...
                          label: 'NOTE *',
                          hint:
                              'Ex: Les fondations sont terminées, béton de bonne qualité...',
                          controller: contenuCtrl,
                          maxLines: 3,
                        ),
                      ],
                        ...
                        Expanded(
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              if (c.isEmpty) {
                                _snack(ctx, 'Note obligatoire', kRed);
                                return;
                              }
                              try {
                                await Supabase.instance.client
  ...
  static Color _crcColor(String s) => s == 'conforme'
      ? const Color(0xFF10B981)
      : s == 'attention'
      ? const Color(0xFFF59E0B)
      : kRed;
  static String _crcLabel(String s) => s == 'conforme'
      ? 'Conforme'
      : s == 'attention'
      ? 'Attention'
      : 'Critique';
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 3),
                        Text(
                          'Pointage sur plans, photos et comptes-rendus',
                          style: TextStyle(color: kTextSub, fontSize: 12),
                        ),
                      ],
                    ),
                            ...
                            child: Row(
                              ...
                              children: [
                                Icon(
                                  ...
                                  size: 13,
                                  color: _subTab == i ? kTextMain : kTextSub,
                                ),
                                const SizedBox(width: 6),
                                Text(
                                  [
                                    'Pointage',
                                    'Photos',
                                    isMobile ? 'CRC' : 'Rapports & Actualités',
                                  ][i],
                                  style: TextStyle(
                                    fontSize: 12,
                                    fontWeight: _subTab == i
                                        ? FontWeight.w700
                                        : FontWeight.w500,
                                    color: _subTab == i ? kTextMain : kTextSub,
                                  ),
  ...
  Widget _buildSubTab(double pad) {
    switch (_subTab) {
      case 0:
        return _buildPointage(pad);
      case 1:
        return _buildGalerie(pad);
      default:
        return _buildCRC(pad);
    }
  }
              ...
              children: [
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Sélectionnez un plan puis cliquez pour ajouter un pointage',
                            style: TextStyle(fontSize: 11, color: kTextSub),
                          ),
                        ],
                      ),
                ...
                if (plans.isEmpty)
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 4),
                        const Text(
                          "Ajoutez des plans dans l'onglet Documents",
                  ...
                  LayoutBuilder(
                    builder: (ctx2, cs2) {
                      final cardW =
                          (cs2.maxWidth / (cs2.maxWidth > 600 ? 3 : 2) - 8)
                              .clamp(120.0, 220.0);
                      return Wrap(
                        spacing: 10,
                        runSpacing: 10,
                        children: plans.map((doc) {
                          ...
                          final nom = nomRaw2.contains('||META||')
                              ? nomRaw2.split('||META||')[0]
                              : nomRaw2.contains('')
                              ? nomRaw2.split('')[0]
                              : nomRaw2;
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Text(
                      'LISTE DES POINTAGES (${_defauts.length})',
                      style: const TextStyle(
                        fontSize: 11,
                        fontWeight: FontWeight.w700,
                        color: kTextSub,
                    ...
                    if (_defauts.isNotEmpty) ...[
                      _chip(
                        '${_defauts.where((d) => d["statut"] == "a_faire").length} à faire',
                        kRed,
                      ),
                      const SizedBox(width: 8),
                      _chip(
                        '${_defauts.where((d) => d["statut"] == "regle").length} réglés',
                        const Color(0xFF10B981),
                      ),
                    ],
                  ],
                ...
                if (_loadingDefauts)
                  ...
                  ..._defauts.map((d) {
                    ...
                    return Container(
                      ...
                      padding: const EdgeInsets.all(12),
                      decoration: BoxDecoration(
                        color: estFait ? const Color(0xFFF0FDF4) : Colors.white,
                        borderRadius: BorderRadius.circular(10),
                        border: Border.all(
                          color: estFait
                              ? const Color(0xFF10B981).withOpacity(0.3)
                      ...
                      child: Row(
                        children: [
                              ...
                              children: [
                                Text(
                                  ...
                                  style: TextStyle(
                                    fontSize: 13,
                                    fontWeight: FontWeight.w600,
                                    color: estFait ? kTextSub : kTextMain,
                                    decoration: estFait
                          ...
                          PopupMenuButton<String>(
                            onSelected: (v) {
                              if (v == 'toggle') _toggleDefautStatut(d);
                              if (v == 'delete') _supprimerDefaut(d);
                            },
                            itemBuilder: (_) => [
                              PopupMenuItem(
                                value: 'toggle',
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 4),
            const Text(
              'Photos classées de la plus récente à la plus ancienne',
              style: TextStyle(color: kTextSub, fontSize: 11),
            ),
            const SizedBox(height: 16),
            if (_loadingPhotos)
                            ...
                            Expanded(
                              child: _PhotoCard(
                                ...
                                onTap: () {
                                  ...
                                  final d =
                                      rowItems[j]['uploaded_at'] as String? ??
                                      '';
                                  if (u.isNotEmpty && !u.startsWith('fichier:'))
                                    _openPhotoPopup(context, u, n, d);
                                },
                              ),
                            ),
                          ],
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4),
                      const Text(
                        'Document officiel avec statut du chantier. Partagé avec le client.',
                        style: TextStyle(fontSize: 11, color: kTextSub),
                      ),
                    ],
                  ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4),
                      const Text(
                        "Note rapide informelle. Observation terrain, info d'avancement.",
                        style: TextStyle(fontSize: 11, color: kTextSub),
                      ),
                    ],
                  ),
              ...
              children: [
                Row(
                  children: [
                    ...
                    const SizedBox(width: 8),
                    const Text(
                      'Comptes-Rendus de Chantier (CRC)',
                      style: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.w700,
                        color: kTextMain,
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${_formatDate(crc['created_at'] ?? '')}  •  Par ${crc['auteur'] ?? ''}',
                                      style: const TextStyle(
                                        fontSize: 11,
                                        color: kTextSub,
                                      ),
...
class _PlanPointageDialog extends StatefulWidget {
  ...
  const _PlanPointageDialog({
    required this.doc,
    required this.projectId,
    required this.onChanged,
  });
  @override
  State<_PlanPointageDialog> createState() => _PlanPointageDialogState();
}
          ...
          child: Column(
            ...
            children: [
              _DialogHeader(
                ...
                subtitle: 'Décrivez le défaut ou la remarque',
              ),
              Padding(
                padding: const EdgeInsets.all(20),
                child: _DField(
                  ...
                  label: 'DESCRIPTION *',
                  hint: 'Ex: Fissure sur le mur nord',
                  controller: ctrl,
                  maxLines: 2,
                ),
              ),
              _DialogActions(
                ...
                onConfirm: () async {
                  ...
                  if (t.isEmpty) {
                    _snack(context, 'Description obligatoire', kRed);
                    return;
                  }
                  try {
                    ...
                    _snack(context, 'Erreur sauvegarde', kRed);
                  }
                },
                label: 'Ajouter',
              ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${_defauts.length} pointage(s) · Tap pour ajouter',
                          style: const TextStyle(color: kTextSub, fontSize: 11),
                        ),
                      ],
                    ),
                    ...
                    child: Listener(
                      ...
                      onPointerUp: (e) {
                        ...
                        if (d != null &&
                          ...
                          _showAddDialog(
                            (s.dx / W).clamp(0.0, 1.0),
                            (s.dy / H).clamp(0.0, 1.0),
                          );
                        }
                      },
                      child: Stack(
                                  ...
                                  children: [
                                    ...
                                    if (_loading)
                                      ...
                                      ..._defauts.asMap().entries.map((e) {
                                        ...
                                        final def = e.value;
                                        final x =
                                            (def['x'] as num? ?? 0).toDouble() *
                                                W -
                                            14;
                                        final y =
                                            (def['y'] as num? ?? 0).toDouble() *
                                                H -
                                            14;
                              ...
                              child: Container(
                                ...
                                child: const Row(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(width: 5),
                                    Text(
                                      'Pincez pour zoomer · Tap pour pointer',
                                      style: TextStyle(
                                        color: Colors.white,
                                        fontSize: 10,
                                      ),
...
class _FloorPlanPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final outer = RRect.fromRectAndRadius(
      Rect.fromLTRB(w * 0.05, h * 0.05, w * 0.95, h * 0.95),
      const Radius.circular(4),
    );
    canvas.drawRRect(outer, fill);
    canvas.drawRRect(outer, paint);
    canvas.drawRect(
      Rect.fromLTRB(w * 0.07, h * 0.07, w * 0.52, h * 0.93),
      paint,
    );
    canvas.drawRect(
      Rect.fromLTRB(w * 0.52, h * 0.07, w * 0.93, h * 0.52),
      paint,
    );
    canvas.drawRect(
      Rect.fromLTRB(w * 0.52, h * 0.52, w * 0.93, h * 0.93),
      paint,
    );
    final dp = Paint()
      ...
      ..style = PaintingStyle.stroke;
    canvas.drawArc(
      Rect.fromCircle(center: Offset(w * 0.52, h * 0.36), radius: h * 0.11),
      -1.57,
      1.57,
      false,
      dp,
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                ...
                label: Text(
                  _uploading ? 'Upload en cours...' : 'Uploader un modèle .glb',
                  style: const TextStyle(
                    color: Colors.white,
                    fontWeight: FontWeight.w700,
                    fontSize: 14,
...
class _CommentairesTabState extends State<_CommentairesTab> {
        ...
        for (final c in data.where((c) => c.role == 'client')) {
          if (!_seenClientIds.contains(c.id)) {
            ...
            NotificationService.add(
              message:
                  '${c.auteur} : ${c.contenu.length > 80 ? '${c.contenu.substring(0, 80)}…' : c.contenu}',
  ...
  Future<void> _send() async {
    ...
    if (raw.isEmpty && !hasFile) {
      _snack(context, 'Message vide', kRed);
      return;
    }
    if (_uploadingFile) {
      _snack(context, 'Upload en cours, patientez...', kAccent);
    ...
    if (hasFile) {
      body =
          '$body||ATTACH||${_attachedFileName ?? 'fichier'}||$_attachedFileUrl';
    }
    ...
    final auteur = (nom != null && nom.isNotEmpty)
        ? nom
        : (widget.project.chef.isNotEmpty ? widget.project.chef : 'Architecte');
            ...
            child: Container(
              ...
              child: commentaires.isEmpty
                  ? _EmptyState(
                      ...
                      message: 'Aucun message pour ce projet',
                    )
                  : ListView.builder(
                      controller: _scroll,
          ...
          if (_attachedFileName != null) ...[
            ...
            Container(
              ...
              child: Row(
                children: [
                  Icon(
                    _uploadingFile ? LucideIcons.loader : LucideIcons.fileText,
                    size: 14,
                    color: kAccent,
                  ),
                  const SizedBox(width: 8),
...
class _BubbleRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: isArchi
            ? CrossAxisAlignment.end
            : CrossAxisAlignment.start,
        children: [
          // Author row
          Row(
            mainAxisAlignment: isArchi
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(
                              _iconForFileName(attachName!),
                              size: 14,
                              color: isArchi ? Colors.white : kAccent,
                            ),
                            const SizedBox(width: 8),
                            Flexible(
                              child: Text(
                            ...
                            Icon(
                              LucideIcons.download,
                              size: 12,
                              color: isArchi ? Colors.white70 : kAccent,
                            ),
                          ],
                        ),
                      ),
        ...
        Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                color: value ? const Color(0xFF10B981) : kTextSub,
                fontSize: 10,
              ),
            ),
          ],
    ...
    child: Padding(
      ...
      child: Column(
        children: [
          ...
          Text(
            message,
            style: TextStyle(color: kTextSub.withOpacity(0.7), fontSize: 14),
          ),
        ],
      ),
    ),
          ...
          Row(
            children: [
              Container(
                ...
                child: Icon(LucideIcons.target, color: barColor, size: 18),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      total == 0
                          ? 'Aucune tâche'
                          : '$terminees tâche(s) terminée(s) sur $total',
                      style: const TextStyle(color: kTextSub, fontSize: 12),
                    ),
                  ],
                ),
